...
'''
python run_inverse_dynamics_model.py \
--weights models/4x_idm.weights \
--model models/4x_idm.model \
--video-path data/Player571-f153ac423f61-20220707-110239.mp4 \
--jsonl-path data/Player571-f153ac423f61-20220707-110239.jsonl
'''
